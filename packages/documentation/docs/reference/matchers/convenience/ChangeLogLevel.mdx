...
| --- | --- | --- |
| logLevel | `string` | The new LogLevel.<br/>One of "none" | "error" | "warn" | "debug" | "maintainerDebug" | "deepMaintainerDebug". see [LogLevel](https://case.contract-testing.io/docs/reference/configuring#loglevel-none--error--warn--debug--maintainerdebug--deepmaintainerdebug) for details |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| logLevel | `java.lang.String` | The new LogLevel.<br/>One of "none" | "error" | "warn" | "debug" | "maintainerDebug" | "deepMaintainerDebug". see [LogLevel](https://case.contract-testing.io/docs/reference/configuring#loglevel-none--error--warn--debug--maintainerdebug--deepmaintainerdebug) for details |
