...
import ReceiverThrowingErrorInternalsJs from '../../examples/generated/\_function-receiver-throwing-error-internals.ts.mdx';
import ReceiverThrowingErrorInternalsJava from '../../examples/generated/\_function-receiver-throwing-error-internals.java.mdx';
...
- In Java, the exception is serialised with Jackson (with the standard
  ...
  so any public getters on your exception class become part of the error internals.
  You can control this with Jackson annotations on the exception class.

<Tabs groupId="language">
  <TabItem value="js" label="Typescript">
    <ReceiverThrowingErrorInternalsJs />
  </TabItem>
  <TabItem value="java" label="Java">
    <ReceiverThrowingErrorInternalsJava />
  </TabItem>
</Tabs>
