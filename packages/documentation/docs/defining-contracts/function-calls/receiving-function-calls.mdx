...
import ReceiverThrowingPayloadJs from '../../examples/generated/\_function-receiver-throwing-payload.ts.mdx';
import ReceiverThrowingPayloadJava from '../../examples/generated/\_function-receiver-throwing-payload.java.mdx';
...
serialised content of the thrown error with a `payload` matcher. How the
...
- In Java, the exception is serialised with Jackson (with the standard
  `Throwable` properties such as the stack trace, cause and message removed),
  so any public getters on your exception class become part of the payload.
  You can control this with Jackson annotations on the exception class.

<Tabs groupId="language">
  <TabItem value="js" label="Typescript">
    <ReceiverThrowingPayloadJs />
  </TabItem>
  <TabItem value="java" label="Java">
    <ReceiverThrowingPayloadJava />
  </TabItem>
</Tabs>
