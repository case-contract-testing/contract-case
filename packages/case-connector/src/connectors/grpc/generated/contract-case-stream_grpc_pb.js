...
var proto_contract$case$stream_pb = require('./contract-case-stream_pb.js');
var google_protobuf_struct_pb = require('google-protobuf/google/protobuf/struct_pb.js');

function serialize_contractcase_DefinitionRequest(arg) {
  if (!(arg instanceof proto_contract$case$stream_pb.DefinitionRequest)) {
...
function deserialize_contractcase_DefinitionRequest(buffer_arg) {
  return proto_contract$case$stream_pb.DefinitionRequest.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}

function serialize_contractcase_DefinitionResponse(arg) {
  if (!(arg instanceof proto_contract$case$stream_pb.DefinitionResponse)) {
    throw new Error(
      'Expected argument of type contractcase.DefinitionResponse',
    );
  }
  return Buffer.from(arg.serializeBinary());
}
...
function deserialize_contractcase_DefinitionResponse(buffer_arg) {
  return proto_contract$case$stream_pb.DefinitionResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
var ContractCaseService = (exports.ContractCaseService = {
  contractDefinition: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: proto_contract$case$stream_pb.DefinitionRequest,
    responseType: proto_contract$case$stream_pb.DefinitionResponse,
...
exports.ContractCaseClient =
  grpc.makeGenericClientConstructor(ContractCaseService);
