...
export type AnyMatcherOrData = unknown;
export type AnyStringMatcher = unknown;
...
// COMMENTED DURING MIGRATION TO JSii 
// Because these types aren't exportable
...
type AnyCaseNodeOrData = AnyMatcherOrData;
...
Commented during migration to JSii, as this type is not exportable
...
export interface CoreShapedObjectMatcher {
  ...
  '_case:matcher:children': Record<string, AnyMatcherOrData>;
}
