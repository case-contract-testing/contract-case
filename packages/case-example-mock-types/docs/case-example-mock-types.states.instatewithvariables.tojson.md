...
[Home](./index.md) &gt; [@contract-case/case-example-mock-types](./case-example-mock-types.md) &gt; [states](./case-example-mock-types.states.md) &gt; [InStateWithVariables](./case-example-mock-types.states.instatewithvariables.md) &gt; [toJSON](./case-example-mock-types.states.instatewithvariables.tojson.md)

## states.InStateWithVariables.toJSON() method
