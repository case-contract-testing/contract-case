...
[Home](./index.md) &gt; [@contract-case/case-example-mock-types](./case-example-mock-types.md) &gt; [base](./case-example-mock-types.base.md) &gt; [ContractCaseCoreBehaviour](./case-example-mock-types.base.contractcasecorebehaviour.md) &gt; [triggers](./case-example-mock-types.base.contractcasecorebehaviour.triggers.md)

## base.ContractCaseCoreBehaviour.triggers property
