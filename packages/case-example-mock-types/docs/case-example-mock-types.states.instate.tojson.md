...
[Home](./index.md) &gt; [@contract-case/case-example-mock-types](./case-example-mock-types.md) &gt; [states](./case-example-mock-types.states.md) &gt; [InState](./case-example-mock-types.states.instate.md) &gt; [toJSON](./case-example-mock-types.states.instate.tojson.md)

## states.InState.toJSON() method
