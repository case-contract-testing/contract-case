...
## [0.29.2](https://github.com/case-contract-testing/contract-case/compare/@contract-case/contract-case-jest-v0.29.1...@contract-case/contract-case-jest-v0.29.2) (2026-06-30)
...
* The following workspace dependencies were updated
  * dependencies
    * @contract-case/cli bumped from 0.29.1 to 0.29.2
    * @contract-case/contract-case-dsl-js bumped from 0.29.1 to 0.29.2
  * devDependencies
    ...
    * @contract-case/case-plugin-base bumped from 0.29.1 to 0.29.2
    * @contract-case/cli bumped from 0.29.1 to 0.29.2
