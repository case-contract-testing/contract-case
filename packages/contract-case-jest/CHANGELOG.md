...
## [0.23.2](https://github.com/case-contract-testing/contract-case/compare/@contract-case/contract-case-jest-v0.23.1...@contract-case/contract-case-jest-v0.23.2) (2025-05-12)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @contract-case/cli bumped from 0.23.1 to 0.23.2
  * devDependencies
    * @contract-case/cli bumped from 0.23.1 to 0.23.2
