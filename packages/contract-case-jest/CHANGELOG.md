...
## [0.21.1](https://github.com/case-contract-testing/contract-case/compare/@contract-case/contract-case-jest-v0.21.0...@contract-case/contract-case-jest-v0.21.1) (2025-03-29)
...
* The following workspace dependencies were updated
  * dependencies
    * @contract-case/case-connector bumped from 0.21.0 to 0.21.1
    ...
    * @contract-case/cli bumped from 0.21.0 to 0.21.1
  * devDependencies
