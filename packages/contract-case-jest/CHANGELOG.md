...
## [0.24.3](https://github.com/case-contract-testing/contract-case/compare/@contract-case/contract-case-jest-v0.24.2...@contract-case/contract-case-jest-v0.24.3) (2025-06-15)
...
* The following workspace dependencies were updated
  * dependencies
    * @contract-case/case-connector bumped from 0.24.2 to 0.24.3
    ...
    * @contract-case/cli bumped from 0.24.2 to 0.24.3
  * devDependencies
    * @contract-case/cli bumped from 0.24.2 to 0.24.3
