...
## [0.27.4](https://github.com/case-contract-testing/contract-case/compare/@contract-case/contract-case-jest-v0.27.3...@contract-case/contract-case-jest-v0.27.4) (2025-10-27)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @contract-case/cli bumped from 0.27.3 to 0.27.4
  * devDependencies
    * @contract-case/cli bumped from 0.27.3 to 0.27.4
