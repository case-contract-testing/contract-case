...
[Home](./index.md) &gt; [@contract-case/case-plugin-base](./case-plugin-base.md) &gt; [mustResolveToString](./case-plugin-base.mustresolvetostring.md)
...
```typescript
mustResolveToString: (matcher: AnyCaseMatcherOrData, context: MatchContext) => string
```
...
the string value that the matcher resolves to
