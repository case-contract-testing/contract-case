### Alternatives to contract testing
...
- End-to-end integration tests. If you want to do end-to-end tests for
  ...
  conditions in the pipeline). For more on this, read [contract testing vs end to end tests](/docs/users/background/contract-testing-vs-e2e.md).
- Schema tests. In some frameworks (eg [gRPC](https://grpc.io/) or
  ...
  messages). For more on this, please see [contract testing vs schema tests](/docs/users/background/contract-testing-vs-schema.md).
